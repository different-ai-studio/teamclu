import { getCurrentDaemonWorkspaceAgent, listDaemonWorkspaces } from '@/lib/daemon-workspaces'
import { isDaemonHttpAvailable, getDaemonModelCatalog, encodeWorkspaceId } from '@/lib/daemon-local-client'
import {
