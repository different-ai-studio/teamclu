...
echo "gen-secrets: wrote ANON_KEY, SERVICE_ROLE_KEY, MQTT_SERVICE_TOKEN, EMQX_JWT_SECRET, AI_GATEWAY_SERVICE_TOKEN, CADDY_GLOBAL_TLS, CADDY_SITE_TLS, CADDY_SITE_SCHEME, SUPABASE_PUBLIC_URL, API_EXTERNAL_URL, SITE_URL to $ENV_FILE"
