-- The session list carries the app a session belongs to.
--
...
-- Everything else is verbatim from 20260831110000, including
-- `plan_cache_mode = force_custom_plan` — the generic plan for this query is a
-- 100x cliff on the sixth execution, see the notes on that migration.
