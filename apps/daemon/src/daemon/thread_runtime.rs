...
pub(crate) async fn fork_thread_binding(
    ...
    let fork_leaf_id = resolve_fork_anchor(backend, params).await.ok_or_else(|| {
        StartRuntimeError::new(
    ...
    let spec = ForkSpec {
        ...
        fork_leaf_id: Some(fork_leaf_id),
    ...
    agent_backend
        ...
        .await
        .map_err(|e| StartRuntimeError::new("THREAD_FORK_FAILED", e.to_string(), "thread_fork"))
}
